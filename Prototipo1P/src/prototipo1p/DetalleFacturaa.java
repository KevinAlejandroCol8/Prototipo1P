 ...
 * @author Alejandro
 */
public class DetalleFacturaa extends javax.swing.JFrame {

    /**
     * Creates new form DetalleFacturaa
     */
    public DetalleFacturaa() {
        initComponents();
    ...
    private void BTINGRESARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTINGRESARActionPerformed
        ...
        try{
            PreparedStatement pst=cn.prepareStatement("INSERT INTO ventasDetalle(documento_ventaenca, codigo_producto,cantidad_ventadet,costo_ventadet,precio_ventadet,codigo_bodega ) VALUES(?,?,?,?,?,?)");
            //PreparedStatement pst=cn.prepareStatement("INSERT INTO tabla2(documento_ventaenca,codigo_cliente,fecha_ventaenca,total_ventaenca,estatus_ventaenca) VALUES(?,?,?,?,?)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetalleFacturaa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetalleFacturaa().setVisible(true);
            }
        });
    }
